...
{
    public class DeletePlantasModel : PageModel
    {
        private readonly ServicioPlantas _servicioPlantas;

        public DeletePlantasModel(ServicioPlantas servicioPlantas)
        {
        ...
        public IActionResult OnPost()
        {
            ...
            {
                var plantas = _servicioPlantas.Obtener();
                var planta = plantas.FirstOrDefault(p => p.PlantaId == Planta.PlantaId);
