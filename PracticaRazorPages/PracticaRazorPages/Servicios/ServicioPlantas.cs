...
namespace Practica1Solucion.Servicios
{
    public class ServicioPlantas
    {
        ...
        public ServicioPlantas()
        {
            ...
            _plantas.Add(new ModeloPlanta
            {
                PlantaId = 2,NombreComun = "Planta de jade",NombreCientifico = "Crassula ovata",Categoria = "plantas suculentas",Foto = "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRu2YLc-z6ZtAy8zoDYUfztcvqwomNuOEa3saPh8GYlGg&s=10"
            });
